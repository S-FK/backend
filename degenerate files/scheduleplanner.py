...
NOON = "12:00"#datetime.time(hour=12, minute=0)
SUPPER = "18:00"#datetime.time(hour=18, minute=0)
END = "23:59"
"""
...
@plac.annotations(
	input_dir=("Input file", "option", "i", str),
	output_dir=("Optional output test file", "option", "o", str),
)
def main(input_dir="test.json", output_dir="yourschedule.json"):
	json_data=[]
	...
	"""STRATEGY 1: Task oriented: Find tasks and fit them into best
	timeslot"""

	"""STRATEGY 2: Slot oriented: Fill in the slots as efficiently
	as possible."""


	"""STRATEGY 3: Lazy scheduler: Simply assign tasks in order of
